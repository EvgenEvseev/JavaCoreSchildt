package Chapter18;
//использование лямбда-выражения для создания компаратора с обратным упорядочением
import java.util.*;
public class CompDemo2 {
    public static void main(String[] args) {
        //передаем компаратор с обратным упорядоченмием древовидному множеству типа TreeSet
